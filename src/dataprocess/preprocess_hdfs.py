...
data_name = f'hdfs_{params["test_ratio"]}_tar'
data_dir = "../../dataset/processed/hdfs"

params = {
    "log_file": "../../dataset/raw/hdfs/HDFS.log_structured.csv",
    "label_file": "../../dataset/raw/hdfs/anomaly_label.csv",
    ...
    **kwargs
    ...
    for _, row in enumerate(struct_log.values):
        ...
        for blk_Id in blkId_set:
            ...
            session_dict[blk_Id]["eventids"].append(row[column_idx["EventId"]])
