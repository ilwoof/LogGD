...
def train(train_loader, valid_loader, test_loader, model, args):
    ...
    for epoch in range(args.num_epochs):
        ...
        early_stopping(valid_loss.mean(), model, 0)
    ...
    precision, recall, F1_score, _ = precision_recall_fscore_support(ground_truth, (pred_label >= 0.5).astype(int), average='binary')
    print(f'precision={precision}, recall={recall}, f1-score={F1_score}, auc-roc={test_roc_ab}\n')
