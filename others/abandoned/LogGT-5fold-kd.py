...
def arg_parse():
    ...
    parser.add_argument('--output_dim', dest='output_dim', default=768, type=int, help='Output dimension')
...
def train(train_loader, test_loader, teacher_model, student_model, args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_idx, batch_data in enumerate(train_loader):
            ...
            embed, embed_node = student_model(batch_data)
            embed_teacher, embed_teacher_node = teacher_model(batch_data)
        ...
        if (epoch + 1) % 10 == 0 and epoch > 0:
            ...
            for batch_idx, batch_data in enumerate(test_loader):
                ...
                test_pred.append(loss.cpu().detach().numpy().flatten())
            ...
            with open('../../src/Experiment_results.txt', 'a+') as f:
